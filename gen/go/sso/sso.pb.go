...
func (x *IsAdmingResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IsAdmingResponse) ProtoMessage() {}

func (x *IsAdmingResponse) ProtoReflect() protoreflect.Message {
	mi := &file_sso_sso_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IsAdmingResponse.ProtoReflect.Descriptor instead.
func (*IsAdmingResponse) Descriptor() ([]byte, []int) {
	return file_sso_sso_proto_rawDescGZIP(), []int{5}
}

func (x *IsAdmingResponse) GetIsAdmin() bool {
	if x != nil {
		return x.IsAdmin
	}
	return false
...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\aisAdmin\x12\x14.auth.isAdminRequest\x1a\x16.auth.isAdmingResponseB\x16Z\x14karpesh.sso.v1;ssov1b\x06proto3"
...
var file_sso_sso_proto_goTypes = []any{
	...
	(*IsAdmingResponse)(nil), // 5: auth.isAdmingResponse
}
var file_sso_sso_proto_depIdxs = []int32{
	...
	5, // 5: auth.Auth.isAdmin:output_type -> auth.isAdmingResponse
